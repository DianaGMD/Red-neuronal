...
datos_tokio = circulo(num_datos=N, R=1.5, latitud=139.6917, longitud=35.6895)
datos_nairobi = circulo(num_datos=N, R=1, latitud=36.817223, longitud=-1.286389)
X = np.concatenate([datos_tokio, datos_nairobi])
X = np.round(X, 3)
print ('X : ', X)
